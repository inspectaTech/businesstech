 ...
 server {
	...
	root /var/www/abinarydatasolution.com/html;

	server_name abinarydatasolution.com www.abinarydatasolution.com;
	...
	#}
        ...
        location / {
          ...
          add_header X-app2-message "abds root section entered" always;
 ...
 server {
    if ($host = www.abinarydatasolution.com) {
        return 301 https://$host$request_uri;
    }


    if ($host = abinarydatasolution.com) {
        return 301 https://$host$request_uri;
    }
