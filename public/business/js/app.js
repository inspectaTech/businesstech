...
function scroll_test()
{
  ...
  if(document.querySelector(".sticky-shrinknav-header.fix_me") == null){
    ...
    $(".sticky-shrinknav-header").css({
      ...
      // backgroundSize: `auto ${zoom_start + winTop/zoom_rate}%`// FAILS to cover all display sizes
      backgroundSize: `${zoom_start + winTop/zoom_rate}% auto`// WORKS - still grows and stretches across all display sizes
    });
  }//if
