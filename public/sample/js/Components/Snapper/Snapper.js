      ...
      if(typeof myProps != "undefined"){
        ...
        // let icon_value = (this.state.orientation_ctrls == true) ? this.state.ctrl_align : "";// for direct tests
          ...
          let snap_ctrls = add_options ? (
                <div className={`${class_maker({prefix, name, main: "snap_ctrls grid", iUN})} ${ctrl_cont_class}`} {...ctrl_cont_style} >
                ...
                <div className={`${class_maker({prefix, name, main: "snap_ctrls flex", iUN})}`} {...ctrl_cont_style} >
                  {snap_btns}
                </div>
              );
